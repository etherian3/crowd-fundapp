        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
          <div className="w-full lg:w-5/12 flex flex-col justify-center -mt-20">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Platform crowdfunding terdesentralisasi menggunakan blockchain untuk transparansi dan keamanan yang lebih baik.
            </p>
            <a
              href="#campaigns"
            ...
            <div className="bg-white rounded-xl shadow-xl p-6">
              ...
              <form onSubmit={createNewCampaign} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full px-6 py-2.5 text-sm font-medium text-white bg-purple-600 rounded-lg hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition-colors duration-200 disabled:bg-purple-300 disabled:cursor-not-allowed mt-2"
                >
                  {isLoading ? (
