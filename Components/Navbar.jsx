        ...
        <div className="relative flex items-center justify-between">
              ...
              {menuList.map((el, i) => (
                <li key={i + 1}>
                  <a
                    ...
                    title="Our product"
                    className="font-medium tracking-wide text-gray-100 transition-colors duration-200 hover:tex-teal-accent-400"
                  >
                    {el}
                  </a>
                </li>
          ...
          <div className="lg:hidden z-40">
            <button
              ...
              title="Open Menu"
              className="p-2 -mr-2 transition duration-200 rounded focus:outline-none focus:shadow-outline"
                      ...
                      >
                        <svg className="w-5 text-gray-600" viewBox="0 0 24 24">
                          <path
                            ...
                            c-0.4,0.4-0.4,1,0,1.4c0.5,0.5,1.1,0.7,1.4,0.7l6.3-6.3l6.3,6.3c0.3,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3
                            c0.4-0.4,0.4-1,0-1.4l-6.3-6.3l6.3-6.3C20.1,5.3,20.1,4.7,19.7,4.3z"
                          />
                        </svg>
                      </button>
                    </div>
